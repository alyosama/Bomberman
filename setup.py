...
class BuildExe:
    def __init__(self):
        #Name of starting .py
        self.script = "BomberMan.py"
 
        #Name of program
        self.project_name = "BomberMan"
        ...
        self.license = "BomberMan License"
 
        #Auhor of program
        self.author_name = "Aly Osama"
        self.author_email = "alyosama@hotmail.com"
        self.copyright = "Copyright (c) 2013 Aly Osama."
 
        #Description
        self.project_description = "BomberMan Description"
